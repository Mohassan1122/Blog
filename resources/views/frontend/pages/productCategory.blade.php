                            ...
                            <div class="col-9 col-sm-6 col-md-4 col-lg-3">
                                <div class="single-product-area mb-30">
                                    <div class="product_image">
                                        ...
                                        @endphp
                                        <img class="normal_img" src="{{ $photo[0] }}" style="width: 350px; height: 350px;" alt="">

                                        <!-- Product Badge -->
                                        <div class="product_badge">
                                            <span>{{ $cat->condition }}</span>
                                        </div>
                                    ...
                                    <div class="product_description">
                                        ...
                                        <p class="brand_name">{{ App\Models\Brand::where('id',$cat->brand_id)->value('title') }}</p>
                                        <a href="#">{{ ucfirst($cat->title)  }}</a>
                                        <h6 class="product-price">${{ number_format($cat->offer_price,2 ) }} <small><del class="text-danger">{{ number_format($cat->price,2 ) }}</del></small></h6>
                                    </div>
                                </div>
                            </div>
                            @endforeach
