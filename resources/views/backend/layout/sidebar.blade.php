            ...
            <div class="tab-pane active" id="admin">
                <nav class="sidebar-nav">
                    <ul class="main-menu metismenu">
                        ...
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-info"></i><span>Banner Management</span> </a>
                            <ul>
                                <li><a href="{{ route('banner.index') }}">All Banners</a></li>
                                <li><a href="{{ route('banner.create') }}">Add Banner</a></li>
                            </ul>
                        </li>
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-list"></i><span>Cartegory Management</span> </a>
                            <ul>
                                <li><a href="{{ route('category.index') }}">All Cartegories</a></li>
                                <li><a href="{{ route('category.create') }}">Add Cartegory</a></li>
                            </ul>
                        </li>
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-target"></i><span>Brand Management</span> </a>
                            <ul>
                                <li><a href="{{ route('brand.index') }}">All Brands</a></li>
                                <li><a href="{{ route('brand.create') }}">Add Brand</a></li>
                            </ul>
                        </li>
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-wallet"></i><span>Product Management</span> </a>
                            <ul>
                        ...
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-basket-loaded"></i><span>Carts Management</span> </a>
                            <ul>
                                <li><a href="Carts.html">All Carts</a></li>
                                <li><a href="add-Carts.html">Add Carts</a></li>
                            </ul>
                        </li>
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-puzzle"></i> <span>Order Management</span> </a>
                            <ul>
                                <li><a href="Order.html">All Order</a></li>
                                <li><a href="add-Order.html">Add Order</a></li>
                            </ul>
                        </li>
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-target"></i><span>Post Category</span> </a>
                            <ul>
                                <li><a href="Categoty.html">All Post Category</a></li>
                                <li><a href="add-Categoty.html">Add Post Category</a></li>
                            </ul>
                        </li>
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-control-pause"></i><span>Post Tag </span> </a>
                            <ul>
                                <li><a href="Post Tag .html">All Post Tag </a></li>
                                <li><a href="add-Post Tag .html">Add Post Tag </a></li>
                            </ul>
                        </li>
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="fas fa-newspaper d-inline-block"></i><span>Post Management</span> </a>
                            <ul>
                                <li><a href="Post.html">All Post</a></li>
                                <li><a href="add-Post.html">Add Post</a></li>
                            </ul>
                        </li>
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-notebook"></i><span>Review Management</span> </a>
                            <ul>
                                <li><a href="Review.html">All Review</a></li>
                        ...
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-star"></i><span>Coupon Management</span> </a>
                            <ul>
                                <li><a href="Review.html">All Review</a></li>
                                <li><a href="add-Review.html">Add Review</a></li>
                            </ul>
                        </li>
                        <li class="active"><a href="index.html"><i class="icon-settings"></i><span>Settings</span></a></li>
                    </ul>
                </nav>
            </div>
