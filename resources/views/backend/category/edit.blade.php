                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" name="is_parent" id="is_parent"  id="" value="{{  $category->is_parent  }}" {{
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 {{
                                    $category->is_parent==1 ? 'd-none' : '' }} " id="parent_cat_id">
                                    <label for="">Parent Category</label>
                                    <select class="form-control show-tick" name="parent_id">
                                        <option value="">-- Parent Category --</option>
                                        @foreach ($parent_carts as $item)
                                        <option value="{{ $item->id }}" {{
                                            $item->id==$category->parent_id ? 'selected' : '' }}  >{{ $item->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                {{-- <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <select class="form-control show-tick" name="condition">
                                        ...
                                        <option value="category" {{ old('condition')=='banner' ? 'selected' : '' }}>Banner
                                        </option>
